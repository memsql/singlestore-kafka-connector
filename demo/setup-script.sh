...
docker exec memsql-kafka-connect cp /home/app/target/memsql-kafka-connector-1.0.0.jar /tmp/quickstart/connect
docker cp /tmp/quickstart/connect/memsql-kafka-connector-1.0.0.jar kafka-connect:/usr/share/java/kafka
