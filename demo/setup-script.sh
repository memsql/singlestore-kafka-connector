...
docker exec singlestore-kafka-connect-short-demo cp /home/app/target/singlestore-kafka-connector-1.2.4.jar /tmp/quickstart/connect
...
kafka-connect-start() {
  ...
  docker run -d \
    ...
    -v /tmp/quickstart/connect/singlestore-kafka-connector-1.2.4.jar:/usr/share/java/singlestore-kafka-connector-1.2.4.jar \
