...
docker exec kafka-connect wget -O /usr/share/java/kafka/singlestore-jdbc-client-1.0.1.jar https://github.com/memsql/S2-JDBC-Connector/releases/download/v1.0.1/singlestore-jdbc-client-1.0.1.jar >/dev/null 2>/dev/null
echo ". Success!"
