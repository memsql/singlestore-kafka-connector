...
public class SingleStoreSinkConfig extends AbstractConfig {
    ...
    private static final String FILTER_DOC = "Specify a SQL expression to filter incoming data";
    ...
    private static  final String UPSERT_DOC = "Update rows in the case of duplicate key";
    private static  final String UPSERT_DISPLAY = "Change behaviour to update rows with duplicate row instead of throwing an error";
